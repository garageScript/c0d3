      ...
      {({ loading, error, data }) => {
        ...
        return (
          <Fragment>
            ...
            <a type='button' className='btn' href={data.lessonInfo.chatUrl} style={{ position: 'fixed', right: 0, bottom: 0, width: '105px', height: '105px', borderRadius: '50%', padding: '0', backgroundColor: 'white' }} target='_blank' rel='noopener noreferrer'>
